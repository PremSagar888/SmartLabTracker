...
@torch.no_grad()
def run(
        source='/home/splab/Downloads/projintern/myproject/lab.mp4',
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/home/splab/Downloads/projintern/myproject/lab.mp4', help='file/dir/URL/glob, 0 for webcam')
